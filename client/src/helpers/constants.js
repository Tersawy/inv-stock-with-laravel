...
export const PURCHASE_STATUS_STR = ["Received", "Pending", "Ordered"];
...
export const PURCHASE_RETURN_STATUS_STR = ["Complated", "Pending"];
...
export const SALE_STATUS_STR = ["Complated", "Pending", "Ordered"];
...
export const SALE_RETURN_STATUS_STR = ["Received", "Pending"];
...
export const QUOTATION_STATUS_STR = ["Sent", "Pending"];
...
export const ADJUSTMENT_DETAILS_STATUS_STR = ["Addition", "Subtraction"];
...
export const ADJUSTMENT_STATUS_STR = ["Approved", "Not Approved"];
...
export const DISCOUNT_METHODS_STR = ["Fixed", "Percent %"];
...
export const PAYMENT_METHODS_STR = ["Cash", "Cheque", "Credit Card", "Westrn Union", "Bank Transfer"];
...
export const PAYMENT_STATUS_STR = ["Paid", "Unpaid", "Partial"];
