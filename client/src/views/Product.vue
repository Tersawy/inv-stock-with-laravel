		...
		<b-container fluid>
			<b-row>
				...
				<b-col class="text-right">
					...
					<b-btn :to="{ name: 'ProductCreate' }" variant="primary" class="d-inline-flex align-items-center">
...
<script>
	...
	export default {
		...
		computed: {
			...mapState({
				items: (state) => state.Product.all.docs,
				docsCount: (state) => state.Product.all.total
			}),
