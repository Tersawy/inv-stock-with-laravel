	...
	<main-content :breads="breads">
		...
		>
			<template #cell(image)="row">
				<b-avatar v-if="row.value" :src="APP_PRODUCTS_URL + row.value" class="shadow-sm" rounded="lg"></b-avatar>
			</template>
			...
			<template #cell(actions)="row">
				<router-link :to="{ name: 'ProductsEdit', params: { productId: row.item.id } }">
