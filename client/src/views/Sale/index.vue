<template>
	<div class="sales-list py-3">
		<b-container fluid>
			<b-row>
				<b-col cols="4">
					<b-form-group class="mb-0">
						<b-input-group>
							<b-form-input placeholder="Search in sales by name" v-model="search" />
				...
				<b-col class="text-right">
					...
					<router-link :to="{ name: 'SaleCreate' }">
			...
			>
				<template #cell(actions)="row">
					<router-link :to="{ name: 'SaleUpdate', params: { invoiceId: row.item.id } }">
