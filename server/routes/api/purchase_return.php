...
Route::group(['middleware' => ['auth:sanctum'], 'prefix' => 'purchase-return'], function () {
...
Route::group(['middleware' => ['auth:sanctum'], 'prefix' => 'purchase-return/{purchaseId}/payments'], function () {
